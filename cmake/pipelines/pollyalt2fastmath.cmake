...
function(pollyalt2fastmath)
  ...
  pipeline_setup(NAME "pollyalt2fastmath" ${ARGV})

  if(NOT DEFINED ENV{POLLYALT2FASTMATH_PASS_MODULE})
    message(FATAL_ERROR "pipeline ${PLINE_NAME} requires env variable: \
    POLLYALT2FASTMATH_PASS_MODULE")
  endif()
  ...
  llvmir_attach_opt_pass_target(
    ...
    -load $ENV{POLLYALT2FASTMATH_PASS_MODULE}
    -polly-canonicalize
