...
function(pollyalt2vec)
  ...
  pipeline_setup(NAME "pollyalt2vec" ${ARGV})

  if(NOT DEFINED ENV{POLLYALT2VEC_PASS_MODULE})
    message(FATAL_ERROR "pipeline ${PLINE_NAME} requires env variable: \
    POLLYALT2VEC_PASS_MODULE")
  endif()
  ...
  llvmir_attach_opt_pass_target(
    ...
    -load $ENV{POLLYALT2VEC_PASS_MODULE}
    -polly-canonicalize
